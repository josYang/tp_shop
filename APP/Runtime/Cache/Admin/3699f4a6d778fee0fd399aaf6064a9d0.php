...
<div id="wrap">
    ...
    <?php if(is_array($node)): foreach($node as $key=>$app): ?><div class="app">
            <p>
                ...
                [<a href="<?php echo U(CONTROLLER_NAME.'/delete',array('id'=>$app['id']));?>" onclick="return confirm('确定删除？？')">删除</a>]
            </p>
            <?php if(is_array($app["child"])): foreach($app["child"] as $key=>$action): ?><dl>
                    <dt>
                        ...
                        [<a href="<?php echo U(CONTROLLER_NAME.'/delete',array('id'=>$action['id']));?>" onclick="return confirm('确定删除？？')">删除</a>]
                    </dt>
                    <?php if(is_array($action["child"])): foreach($action["child"] as $key=>$method): ?><dd>
                            ...
                            [<a href="<?php echo U(CONTROLLER_NAME.'/delete',array('id'=>$method['id']));?>" onclick="return confirm('确定删除？？')">删除</a>]
